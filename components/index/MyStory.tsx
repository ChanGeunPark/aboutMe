  ...
  return (
    <article className="min-h-screen flex items-center overflow-hidden relative py-16 px-3">
      <div className="container mx-auto">
        <div className="flex items-center text-5xl md:text-7xl font-extrabold relative">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-12 mt-16">
          ...
          <div className="sm:col-span-7 lg:col-span-9 pl-0 sm:pl-28 mt-12 sm:mt-0">
            ...
            <p className="mt-9 text-zinc-500 text-base md:text-lg leading-loose sm:leading-[2.3]">
              ...
              곳에서 경험을 하다가{" "}
              <span className="font-bold text-2xl text-black">문득!</span> 든
              ...
              개발자의 세계. 모르는게 있으면{" "}
              <span className="text-xl text-indigo-600 font-bold">배우고</span>,{" "}
